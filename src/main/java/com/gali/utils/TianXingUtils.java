...
public class TianXingUtils {
    ...
    //舔狗日记接口
    public static String getDogPi() {
        String httpUrl = "http://api.tianapi.com/tiangou/index?key=自己的key";//key后面填自己的天行数据key
    ...
    public static Map<String,String> getEnsentence() {
        String httpUrl = "http://api.tianapi.com/ensentence/index?key=自己的key";//key后面填自己的天行数据key
        BufferedReader reader = null;
        String result = null;
        StringBuffer sbf = new StringBuffer();
        try {
